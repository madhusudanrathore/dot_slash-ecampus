<?php require './header.php'; ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h3 style="color: #0EA300; border-bottom: #0EA300 solid 2px; margin-top: 2px;">Campus ForHire Posts</h3>
				<?php
					$m = new model();
					$result = $m->get_all_hire();
				...
				<div class="jumbotron">
					...
					<p class="lead">Vehicle type: <?php echo $row["USER_TYPE"]; ?> Wheeler</p>
